 ...
 * Optionally define static to control the API's visibility
...
/*
 * Optparse is used in once for every executable and only the long
 * options are utilized so this header has been modified and stripped
 * accordingly.
 */
#pragma once
